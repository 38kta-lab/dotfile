...
```bash
python3 /Users/kta38-air/.config/codex/skills/daily-search-trend/scripts/fetch_papers.py --keywords "cyanobacteria,photosystem II,carbon fixation" --hours 24
```
...
```bash
python3 /Users/kta38-air/.config/codex/skills/daily-search-trend/scripts/render_trend_html.py ideas/daily/md/YYYY-MM-DD-trend.md -o ideas/daily/YYYY-MM-DD-trend.html
```
